...
client.on('message', message => {
  ...
  if (message.author.id !== "579420283723710494") return;
...
client.on("guildCreate", guild => {
  ...
  .setTimestamp()
  client.channels.get(" 579420283723710494").send(embed)
});

client.login('NTc5NjU0MzM3NzE0NzE2Njcy.XOFXmA.it2zsAPhBVG9N8BJUxOtJKFe_Xg');